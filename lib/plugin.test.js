...
describe("This here plugin", () => {
  ...
  it("should add text to headers in markdown content with correct colors", () => {
    ...
    const expectedOutput = `# <mark style="color:#F5614C;">Header 1</mark><!-- {"cycleColor": "23"} -->\nSome content\n## <mark style="color:#F9B68D;">Header 2</mark><!-- {"cycleColor": "35"} -->\nMore content\n### <mark style="color:#BBE077;">Header 3</mark><!-- {"cycleColor": "37"} -->\nEven more content`;
